  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="dark:text-white mt-10 font-palanquin text-8xl max-sm:text-[72px] mx-sm:leading-[82px] font-bold">
          <span className="xl:bg-white dark:xl:bg-black xl:whitespace-nowrap relative z-10 pr-10 ">
            The New Arrival
          </span>
          <br />
        ...
        <div className="flex justify-start items-start flex-wrap  w-full mt-20  gap-16">
          {statistics.map((stat) => (
            <div key={stat.label}>
              ...
              <p className="leading-7 font-montserrat text-slate-gray dark:text-white">
                {stat.label}
              </p>
            </div>
          ))}
