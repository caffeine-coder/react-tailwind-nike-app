...
const Subscribe = () => {
  ...
  items-center max-lg:flex-col gap-10"
    ...
    >
      ...
      <div className="  lg:max-w-[40%] w-full flex items-center max-sm:flex-col gap-5 p-2.5 sm:border sm:borderslate-gray rounded-full">
        <input
          type="text"
          placeholder="Subscribe @ Nike"
          className="input dark:placeholder:text-white-400 dark:bg-black"
        />
